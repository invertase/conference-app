...
abstract class _Session implements Session {
  const factory _Session(
      ...
      @JsonKey(defaultValue: false) required final bool isServiceSession,
      @JsonKey(defaultValue: false) required final bool isPlenumSession,
      @JsonKey(defaultValue: []) required final List<dynamic> speakers,
      @JsonKey(defaultValue: []) required final List<dynamic> categoryItems,
      @JsonKey() final String? liveUrl,
      @JsonKey() final String? recordingUrl}) = _$_Session;
